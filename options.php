...
function video_embed_privacy_settings_init() {
	...
	add_settings_field('video_embed_privacy_text_field_1', __('HMTL below play button text', 'video-embed-privacy'), 'video_embed_privacy_text_xx_render', 'vepPage', 'video_embed_privacy_vepPage_section_' . $id, $id . '_hint');
	}
}
